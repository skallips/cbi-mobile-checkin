...
<html>
    ...
    <body>
        ...
        <div class="middle">
            <p style="text-align:center;"><p class="popText">Get a head start on your check-in process!</p></p><br>
            <p class="regularText">Please enter the following information of the Primary Guest on the reservation.</p>
        </div>
